...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    Mail: Schema.Attribute.Component<'shared.mail', true>;
...
export interface ApiNavBarNavBar extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    icone_burger: Schema.Attribute.Component<'elements.image', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::nav-bar.nav-bar'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    single_pages: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiSinglePageSinglePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    is_present_in_navbar: Schema.Attribute.Boolean &
    ...
    pageName_navbar: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
